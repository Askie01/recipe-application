...
import com.askie01.recipeapplication.configuration.AmountMapperConfiguration;
...
@SpringJUnitConfig(classes = AmountMapperConfiguration.class)
@Import(value = AmountValidatorConfiguration.class)
