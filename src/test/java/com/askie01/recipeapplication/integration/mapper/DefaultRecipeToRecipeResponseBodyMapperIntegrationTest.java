...
@SpringJUnitConfig(classes = RecipeToRecipeResponseBodyMapperConfiguration.class)
@TestPropertySource(properties = "component.mapper.recipe-to-recipe-response-body-type=default")
@RequiredArgsConstructor(onConstructor_ = @Autowired)
@DisplayName("DefaultRecipeToRecipeResponseBodyMapper integration tests")
@EnabledIfSystemProperty(named = "test.type", matches = "integration")
class DefaultRecipeToRecipeResponseBodyMapperIntegrationTest {
