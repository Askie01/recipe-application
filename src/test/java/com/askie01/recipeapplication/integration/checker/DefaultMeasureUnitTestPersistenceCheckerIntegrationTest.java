...
class DefaultMeasureUnitTestPersistenceCheckerIntegrationTest {

    private MeasureUnit source;
    private final MeasureUnitTestFactory factory;
    private final MeasureUnitTestPersistenceChecker checker;

    @BeforeEach
    void setUp() {
        this.source = factory.createMeasureUnit();
    }
