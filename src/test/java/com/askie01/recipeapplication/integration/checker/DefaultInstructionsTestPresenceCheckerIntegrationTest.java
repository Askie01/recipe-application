...
import com.askie01.recipeapplication.configuration.DefaultInstructionsTestPresenceCheckerTestConfiguration;
...
@ContextConfiguration(classes = DefaultInstructionsTestPresenceCheckerTestConfiguration.class)
@RequiredArgsConstructor(onConstructor_ = @Autowired)
@DisplayName("DefaultInstructionsTestPresenceChecker integration tests")
@EnabledIfSystemProperty(named = "test.type", matches = "integration")
class DefaultInstructionsTestPresenceCheckerIntegrationTest {

    private HasInstructions source;
    private final InstructionsTestPresenceChecker checker;
