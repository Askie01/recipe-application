...
@DisplayName("DefaultRecipeRequestBodyToRecipeMapper unit tests")
@EnabledIfSystemProperty(named = "test.type", matches = "unit")
class DefaultRecipeRequestBodyToRecipeMapperUnitTest {
    ...
    void setUp() {
        ...
        this.mapper = new DefaultRecipeRequestBodyToRecipeMapper();
    }
