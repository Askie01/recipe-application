...
@DisplayName("DefaultCategoryTestPersistenceChecker unit tests")
@EnabledIfSystemProperty(named = "test.type", matches = "unit")
class DefaultCategoryTestPersistenceCheckerUnitTest {

    private Category source;
    private CategoryTestPersistenceChecker checker;
    ...
    @BeforeEach
    void setUp() {
        this.checker = new DefaultCategoryTestPersistenceChecker(
                longIdTestPresenceChecker,
                stringNameTestPresenceChecker,
                simpleAuditTestPresenceChecker,
                longVersionTestPresenceChecker
        );
        this.source = new RandomCategoryTestFactory(Faker.instance()).createCategory();
    }
