...
@DisplayName("DefaultRecipeDifficultyTestPresenceChecker unit tests")
@EnabledIfSystemProperty(named = "test.type", matches = "unit")
class DefaultRecipeDifficultyTestPresenceCheckerUnitTest {

    private Recipe source;
    private RecipeDifficultyTestPresenceChecker checker;
    ...
    void setUp() {
        this.source = Recipe.builder()
                ...
                .build();
        this.checker = new DefaultRecipeDifficultyTestPresenceChecker();
    }
