...
@DisplayName("DefaultServingsTestPresenceChecker unit tests")
@EnabledIfSystemProperty(named = "test.type", matches = "unit")
class DefaultServingsTestPresenceCheckerUnitTest {

    private HasServings source;
    private ServingsTestPresenceChecker checker;

    @BeforeEach
    void setUp() {
        this.checker = new DefaultServingsTestPresenceChecker();
