...
@Configuration
@ConditionalOnProperty(name = "component.mapper.recipeDTO-to-recipe-type", havingValue = "simple")
public class SimpleRecipeDTOToRecipeMapperConfiguration {

    @Bean
    public RecipeDTOToRecipeMapper recipeDTOToRecipeMapper(LongIdMapper longIdMapper,
